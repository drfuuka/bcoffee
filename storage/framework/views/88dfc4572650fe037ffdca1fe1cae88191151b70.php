	...
	<div id="carousel-header" class="carousel slide carousel-fade" data-bs-ride="false">
		...
		<div class="carousel-inner">
		  <div class="carousel-item active">
			<img src="<?php echo e(asset('images/header/1.jpg')); ?>" class="d-block w-100" alt="...">
		  ...
		  <div class="carousel-item">
			<img src="<?php echo e(asset('images/header/2.jpg')); ?>" class="d-block w-100" alt="...">
			<div class="carousel-caption">
			  <h5>Biarkan dirimu menikmati yang terbaik!</h5>
		  ...
		  <div class="carousel-item">
			<img src="<?php echo e(asset('images/header/3.jpg')); ?>" class="d-block w-100" alt="...">
			<div class="carousel-caption">
			  <h5>Biarkan dirimu menikmati yang terbaik!</h5>
			  <h1 class="display-2 fw-bold">Rasakan kenikmatan secangkir <br> yang sempurna</h1>
			  <button class="btn btn-outline-light mt-3 d-none d-md-block mx-auto">Tentang Kami</button>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6 align-self-center">
				...
				<a href="<?php echo e(route('promo')); ?>" class="btn btn-primary">Lihat semua promo</a>
			</div>
			<div class="col-md-6 align-self-center mt-5 mt-md-0">
				<div class="row justify-content-center">
					<div class="col-6">
						<div class="promo-container">
							<img src="<?php echo e(asset('images/promo-featured/1.jpg')); ?>" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-6">
						<div class="promo-container">
							<img src="<?php echo e(asset('images/promo-featured/2.jpg')); ?>" alt="" class="img-fluid">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center">
			...
			<div class="col-sm-6 col-lg-4 align-self-center mt-5">
				<div class="img-container owl-carousel owl-theme">
					<img src="<?php echo e(asset('images/featured-coffee/1.png')); ?>" alt="" class="img-fluid item">
					<img src="<?php echo e(asset('images/featured-coffee/1.png')); ?>" alt="" class="img-fluid item">
					<img src="<?php echo e(asset('images/featured-coffee/1.png')); ?>" alt="" class="img-fluid item">
				</div>
			</div>
			...
			<?php $__currentLoopData = $bestSeller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-10 col-lg-4 d-flex">
					<div class="card text-primary w-100">
						<img src="<?php echo e(asset('storage/'.$item['foto'])); ?>" alt="" class="img-fluid">
						<div class="col-8">
							<div class="p-3">
								<div class="bg-primary text-white d-inline p-3 py-2 rounded-pill">
									<span><?php echo e($item['jenis']); ?></span>
								</div>
							</div>
							<div class="card-body">
								<h5 class="fw-bold"><?php echo e($item['nama_produk']); ?></h5>
								<span class="fw-bold">Rp.<?php echo e($item['harga']); ?></span>
							</div>
						</div>
					</div>
				</div>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Code\bcoffee\resources\views/home.blade.php ENDPATH**/ ?>